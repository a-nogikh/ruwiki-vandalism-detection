...
counter = Counter(100)
for raw in client.wiki['any_train'] .find({}, {'vandal': 1,  TEXT_FEATURE_KEY: 1}): #strict_train,new_big_train,train_wcancel
...
lr = LogisticRegression(solver='sag', verbose=1, class_weight="balanced", max_iter=300, C=0.01)
#lr = BernoulliNB()
lr.fit(matrix, raw_res)

lr2 = LogisticRegression(solver='sag', verbose=1,class_weight="balanced", max_iter=300, C=0.01)
#lr2 = GaussianNB()
...
print("Train..")
set_features('train_wcancel')

#print("Train2..")
#set_features('any_train')